from models.regularized_logistic_regression.variants.reg_log import RegularizedLogisticRegressionGD
...
model = RegularizedLogisticRegressionGD()

   

for i in range(6):

    model.fit(X_train, y_train , 0.01 , 1*(10**i) , 1)
